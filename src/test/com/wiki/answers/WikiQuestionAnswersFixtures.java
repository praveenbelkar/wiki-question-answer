...
public class WikiQuestionAnswersFixtures {
    ...
    public static String getAnswers() {
        String answers = "subgenus Hippotigris; the plains zebra, the Grévy's zebra and the mountain zebra;horses and donkeys;aims to breed zebras that are phenotypically similar to the quagga; Grévy's zebra and the mountain zebra";
        return answers;
    }
